...
$open_generic_link = '<a href="https://www.google.it/">';
$close_generic_link = '</a>';
$questions = [
    ...
    "<h2>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h2>" => [
        ...
        "<p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel$open_generic_link Centro Google per la sicurezza online$close_generic_link.</p>",
        "<p>$open_generic_link Scopri $close_generic_link quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>",
    ],
    ...
    "<h2>Perché il mio account è associato a un paese?</h2>" => [
        ...
        "<ol><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:<ol></li>",
    ...
    "<h2>Stabilire il paese associato al tuo account</h2>" => [
        ...
        "<p>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale.$open_generic_link Contattaci $close_generic_link se ritieni che il paese associato al tuo account sia sbagliato.</p>",
    ],

    "<h2>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h2>" => [
        "<p>I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori di ricerca non possono rimuovere i contenuti direttamente dai siti web, quindi rimuovere risultati di ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web, devi $open_generic_link contattare il webmaster$close_generic_link del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, $open_generic_link fai clic qui$close_generic_link. Una volta che i contenuti saranno stati rimossi e che Google avrà rilevato l'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. In caso di una richiesta di rimozione urgente, è inoltre possibile $open_generic_link visitare la nostra pagina di assistenza per avere ulteriori informazioni $close_generic_link.</p>",
    ],

    "<h2>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h2>" => [
        "<p>In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina web di destinazione anche l'indirizzo Internet, o URL, della pagina dei risultati di ricerca sotto forma di $open_generic_link URL referrer $close_generic_link. Talvolta, l'URL della pagina dei risultati di ricerca potrebbe contenere la query di ricerca che hai inserito. Se utilizzi la ricerca SSL (la funzione di ricerca criptata di Google), nella maggior parte dei casi i termini di ricerca non vengono inviati come parte dell'URL negli URL referrer. Questo comportamento può fare eccezione, ad esempio se utilizzi alcuni browser meno diffusi. Ulteriori informazioni sulla ricerca SSL sono disponibili $open_generic_link qui $close_generic_link. Le query di ricerca o le informazioni contenute nell'URL referrer potrebbero essere disponibili mediante Google Analytics o un'API (Application Programming Interface). Inoltre, gli inserzionisti potrebbero ricevere informazioni relative all' esatte parole chiave che hanno determinato il clic su un annuncio.</p>",
    ],
   ];
